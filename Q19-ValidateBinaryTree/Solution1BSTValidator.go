...
func (s Solution1BSTValidator) Validate(n *solve_common_problems_using_go.BSTNode) bool {
...
func (s Solution1BSTValidator) validateWithBoundaries(n *solve_common_problems_using_go.BSTNode, minLeft, maxRight int) bool {
	if n == nil {
		return true
	}
