...
import "github.com/solve_common_problems_using_go/stacks/findBalancedStrWithMinBrackets"

type Solution2QUsingStack struct {
	stack1 findBalancedStrWithMinBrackets.Stack
	stack2 findBalancedStrWithMinBrackets.Stack
}
